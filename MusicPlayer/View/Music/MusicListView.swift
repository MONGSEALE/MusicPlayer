...
struct MusicListView: View {
    ...
    @State private var bottomSheetHeight: CGFloat? = 90
    ...
    var computedBlur: CGFloat {
        ...
        guard bottomSheetHeight ?? 90 > minHeight else { return 0 }
        
        // 진행률을 0~1로 계산한 뒤, 비선형(easing) 함수를 적용
        let normalized = (bottomSheetHeight ?? 90 - minHeight) / (sheetTotalHeight - minHeight)
